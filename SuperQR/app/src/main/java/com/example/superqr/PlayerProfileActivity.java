    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        highQRScoreButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                new ViewQRScoreFragment(player.getPlayerID(), player.getStats().getHighestScore()).show(getSupportFragmentManager(), "VIEW_HIGH_QR");
            }
        });
        ...
        lowQRScoreButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                // need to pass in actual qr picture
                new ViewQRScoreFragment(player.getPlayerID(), player.getStats().getLowestScore()).show(getSupportFragmentManager(), "VIEW_LOW_QR");
            }
        });
    }
