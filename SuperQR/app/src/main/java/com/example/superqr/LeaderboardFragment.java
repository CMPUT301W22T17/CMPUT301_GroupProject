                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if(task.isSuccessful()){
                            for (QueryDocumentSnapshot document : task.getResult()){
                                ...
                                Player xzc= playerList.get(0);
                                Log.d(TAG,"Player list check"+xzc.getSettings().getUsername());
                                Log.d(TAG, "Firebase player" + player.getSettings().getUsername());
                                Log.d(TAG,"Firebase Score" + player.getStats().getHighestScore());
                            }
                        }
                    }
                });
